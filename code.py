...
Original file is located at
    https://colab.research.google.com/drive/1qLYFU7nHTIz-_QxH1cZyyQx8lrpJDYwz
"""
...
#Question 3:
#CNN with kernel-size as 3*3 and feature maps as 10,20 for 2 convolution layers respectively
model2 = Sequential()
